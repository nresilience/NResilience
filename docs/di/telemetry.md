...
| `nresilience.stream_resumed` | A stream was restarted from the caller's last checkpoint. See [Checkpointed resume](../reference/events.md#event-invariants-and-behavior). |
