...
- The four exceptions, their properties, and who sets `RetryAfter`: see [Exceptions](../reference/exceptions.md).
- Why a rejected call waits out the rejection pause before throwing: see [the guarded rejection deep dive](../deep-dives/guarded-rejection.md).