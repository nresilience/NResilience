...
| `NResilience.Grpc`       | The gRPC client interceptor: status classification, `grpc-timeout` propagation, and per-service scoping. The HTTP handler does nothing for gRPC. |
