...
public sealed class Arm
{
    ...
    public static Arm Of<T>(string name, Func<ValueTask<T>> body, AllocationCounter counter, Action? betweenOperations = null) =>
        new(name, counter, (warmup, iterations, repeats) =>
            AllocationProbe.MeasureAsync(name, body, counter, warmup, iterations, repeats,
                betweenOperations));
...
public static class Arms
{
    public static IReadOnlyList<Arm> Suspending()
    {
        ...
        [
            ...
            Arm.Of("lib: Default + saturation", ShippingScenarios.DefaultSaturationSuspending, AllocationCounter.ProcessWide),
    ...
    [
        ...
        Arm.Of("raw ValueTask callback (baseline)", Scenarios.RawValueSync, AllocationCounter.ThreadLocal),
        ...
        Arm.Of("lib: saturation, static+state", ShippingScenarios.DefaultSaturationSyncState, AllocationCounter.ThreadLocal),
