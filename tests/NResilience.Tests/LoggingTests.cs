...
public sealed class LoggingTests
{
    ...
    public void Event_ids_are_stable()
    {
        ...
        [
            ...
            (Log.Ids.StreamResumed.Id, Log.Ids.StreamResumed.Name!),
            (Log.Ids.Draining.Id, Log.Ids.Draining.Name!),
        ];
    ...
    public async Task A_limited_attempt_reports_its_own_event_id()
    {
        ...
        await Assert.ThrowsAnyAsync<Exception>(() => api.RunAsync(
            _ => throw new RateLimitedException(TimeSpan.FromSeconds(1), "quota"),
